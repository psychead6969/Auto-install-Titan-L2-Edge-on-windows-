...
REM Define an array of custom ports (for example, ports 1235, 1236, 1237, 1238, 1239)
...
for /f "tokens=1,2,3,4,5 delims=," %%a in ("%ports%") do (
    ...
    cmd.exe /c "cd C:\titan-edge && titan-edge daemon start --init --url https://cassini-locator.titannet.io:%%a/rpc/v0"
